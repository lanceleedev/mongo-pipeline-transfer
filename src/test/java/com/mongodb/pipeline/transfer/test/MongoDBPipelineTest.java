...
public class MongoDBPipelineTest {
    ...
    public static String getHJ_CollectedTxAggregate() {
    ...
    public static String getYH_GatheringAggregate() {
    ...
    public static String getCollectedTx() {
    ...
    public static void query(MongoCollection<Document> collection, List<Bson> bsonList) {
